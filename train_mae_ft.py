...
from timm.optim import create_optimizer_v2, optimizer_kwargs, LayerDecayValueAssigner, create_optimizer
...
def main():
    ...
    if args.local_rank == 0 and has_wandb and args.log_wandb:
